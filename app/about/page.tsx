...
export default function Page(){return <Shell>
  ...
  </div><div className="partner-mark"><img src="/assets/brainfarm-emblem.png" alt="BrainFarm USA emblem"/><strong>Two companies.</strong><span>One technology lifecycle.</span><a className="button" href="https://www.brainfarmusa.ai" target="_blank" rel="noreferrer">Visit BrainFarm USA ↗</a></div></div></section>
