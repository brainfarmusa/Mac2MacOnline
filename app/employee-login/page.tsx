...
export default function EmployeeLogin(){
  ...
  useEffect(()=>{
    void currentPddSession().then(session=>{if(session)window.location.replace("/employee")});
