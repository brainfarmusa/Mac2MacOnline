...
export default function ExportComplianceReviews(){
 ...
 return <main className="applicationRecordsPage"><header><div><p className="eyebrow">EXPORT COMPLIANCE</p><h1>End-Use Certifications</h1><p>Review the customer’s parties, destination, products and intended use before any export proceeds.</p></div><a href="/employee">← Dashboard</a></header>
