...
export function Footer(){return <footer><div className="footer-grid">
<div><img src="/assets/m2m-logo-transparent.png" alt="Mac2MacOnline" className="footer-logo"/><p>Wholesale technology remarketing, responsible recovery and practical resale solutions.</p><Link href="/customer-onboarding">Customer Onboarding</Link><Link href="/vendor-onboarding">Vendor Onboarding</Link><Link href="/export-compliance">Export Compliance</Link></div>
<div><h3>We Buy</h3><Link href="/trade-in">Trade-In Program</Link><Link href="/we-buy-ram">RAM &amp; Memory</Link><Link href="/sell-ddr4-server-ram">DDR4 Server RAM</Link><Link href="/sell-ddr5-server-ram">DDR5 Server RAM</Link><Link href="/sell-mixed-untested-ram">Mixed &amp; Untested RAM</Link><Link href="/we-buy-ssds">SSDs &amp; Storage</Link><Link href="/sell-enterprise-nvme-ssds">Enterprise NVMe SSDs</Link><Link href="/we-buy-gpus">GPUs &amp; AI Accelerators</Link><Link href="/we-buy-apple-equipment">Apple Equipment</Link><Link href="/sell-used-servers-networking">Servers &amp; Networking</Link><Link href="/want-to-sell">Submit Other Equipment</Link></div>
