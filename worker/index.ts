...
const worker = {
  async fetch(request: Request, env: Env, ctx: ExecutionContext): Promise<Response> {
    ...
    // Consolidate the retired public landing page under the Live Bid Board URL.
    // Deal detail and employee builder routes remain at their existing paths.
    if (url.pathname === "/public-deal-desk" || url.pathname === "/public-deal-desk/") {
      return Response.redirect(new URL(`/live-bid-board${url.search}`, "https://www.mac2maconline.com").toString(), 301);
    }
